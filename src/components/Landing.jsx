    ...
    return (
        <div className="bg-no-repeat bg-center h-screen bg-[url('./images/image-fond-landing-page.png')]"> 
            <div className="flex flex-wrap content-center justify-center h-screen ..." >
                <div>
                        <img className={Dorsleft ? '-translate-x-48' :''} src="../images/logo_texture_porte_gauche.png" onClick={handleChange}/>
                </div>
                <div>
                        <img className={DorsRight ? 'translate-x-48' :''} src="../images/logo-texture-porte-droite.png" onClick={handleChange}/>
                </div>
            </div>
        </div>
    )
